...
const initialState: SiteState = {
	...
	isMobile: false,
	fontSize: 'sm',
	bgColor: 'linear-gradient(135deg, rgb(71, 120, 209) 29%, rgb(247, 170, 248) 100%)',
	variableEnv: null,
	routerActive: '/',
};
...
export const {updateRouterPrev, setLoading, updateSort, toogleOpenLogout, setIsMobile, setFontSize, setBgColor, setVariableEnv, setRouterActive} =
	siteSlice.actions;
